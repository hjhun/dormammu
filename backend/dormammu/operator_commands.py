...
COMMAND_MATRIX: tuple[OperatorCommandSpec, ...] = (
    ...
    OperatorCommandSpec("cli", "terminal", "terminal", "TerminalSessionManager", "write", "Manage persistent terminal sessions."),
    OperatorCommandSpec("cli", "web", "web", "FastAPI", "write", "Start the web operator console."),
    ...
    OperatorCommandSpec("telegram", "/ask", "run", "CliAdapter", "write", "Run a fast one-pass answer."),
    OperatorCommandSpec("telegram", "/run_fast", "run", "CliAdapter", "write", "Run a fast one-pass answer."),
