...
2. Identify the expected deliverable: local package, installer, archive, release artifact, or deployment bundle.
...
5. Mark completed prompt-derived packaging phase items in `.dev/PLAN.md`.
