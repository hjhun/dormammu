...
from dormammu._cli_web_parser import add_terminal_and_web_parsers
...
def build_parser() -> argparse.ArgumentParser:
    ...
    add_terminal_and_web_parsers(
        subparsers,
        add_repo_root=_add_repo_root,
        add_debug=lambda parser: _add_debug(
            parser,
            help="Show web dependency import errors.",
        ),
        handle_terminal=_handle_terminal,
        handle_web=_handle_web,
    )
