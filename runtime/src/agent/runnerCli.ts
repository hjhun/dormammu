...
function isDaemonPromptSessionPayload(
  payload: RunnerCliPayload
): payload is DaemonPromptSessionEntrypointPayload {
  return (
    "entrypoint" in payload &&
    payload.entrypoint === "daemon_prompt_session_decision"
  );
...
function isDaemonRunLifecycleEventPayload(
  payload: RunnerCliPayload
): payload is DaemonRunLifecycleEventEntrypointPayload {
  return (
    "entrypoint" in payload &&
    payload.entrypoint === "daemon_run_lifecycle_event_decision"
  );
...
function isDaemonResultReportAuthoringPayload(
  payload: RunnerCliPayload
): payload is DaemonResultReportAuthoringEntrypointPayload {
  return (
    "entrypoint" in payload &&
...
function isDaemonPromptCompletionLinePayload(
  payload: RunnerCliPayload
): payload is DaemonPromptCompletionLineEntrypointPayload {
  return (
    "entrypoint" in payload &&
    payload.entrypoint === "daemon_prompt_completion_line_decision"
  );
